...
def add_text(video_name, text, fontsize=30, color="black", x=20, y=190, start_time=0, end_time=None):
    ...
    text = TextClip("text", color="white", fontsize=30)
    text = text.set_pos((x, y)).set_duration(duration)
