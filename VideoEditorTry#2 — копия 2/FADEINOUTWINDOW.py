...
class FadeWindow(QWidget):
    ...
    def __init__(self, vindow, w, h):
        ...
        self.fade_in.clicked.connect(lambda: self.vindow.fade_in_video(self, self.combobox_duration.currentText()))
        self.fade_out.clicked.connect(lambda: self.vindow.fade_out_video(self, self.combobox_duration.currentText()))
