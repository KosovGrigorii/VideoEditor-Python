...
from video_cutter import cut_video, extract_audio, rotate_video, fade_in, fade_out, add_text, concatenate_video, \
...
class Thread(QThread):
    ...
    def set_params(self, msg, video_name, start_time, end_time, rotate_degree=0, duration=0,
                   text="", fontsize=30, color="black", x=20, y=190, video_name2=None,
    ...
    def run(self):
        ...
        if self.msg == Thread.MSG_CUT_VIDEO:
            ...
            subclip_name = add_text(self.video_name, self.text, self.fontsize, self.color, self.x, self.y,
