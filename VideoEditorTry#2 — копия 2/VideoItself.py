...
class Labelik(QtWidgets.QWidget):
    def __init__(self, parent=None):
        super(Labelik, self).__init__(parent)
        self._slider = None
        self._values = []
...
class VideoWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.labellay.addWidget(self.note, 1)
    ...
    def handleError(self):
        self.playButton.setEnabled(False)
        self.errorLabel.setText("Error: " + self.video_player.errorString())
    ...
    def add_text_video(self, wind,  text="", fontsize=30, color="black", x=20, y=190):
        if self._check_duration():
            self.thread = Thread()
            x1 = int(x)
            y1 = int(y)
